...
# Native theme system to replace qt-material
THEMES = {
    'Default': '',
    'Dark': '''
    ...
    'Light': '''
        ...
        QComboBox { background-color: #ffffff; border: 1px solid #ccc; padding: 3px; }
        QSpinBox { background-color: #ffffff; border: 1px solid #ccc; }
...
class UIFunc(QMainWindow, Ui_UIView):
    ...
    def __init__(self, app):
        ...
        # Config
        self.choice_theme.addItems(list(THEMES.keys()))
        ...
        # For tune playing (QSound doesn't support volume control)
        # Volume slider is kept for UI compatibility but has no effect
        self.volumeSlider.setValue(50)
        self.volumeSlider.setEnabled(False)  # Disable since QSound doesn't support volume
